...
public class AttendanceService {
	...
	/* public List<Attendance> getAttendanceByEmployeeLastName(String employeeLastName) {
	 ...
	 public List<Attendance> getAttendanceByEmployeeFirstName(String employeeFirstName) {
	        List<Attendance> attendanceList = new ArrayList<>();
	        attendanceRepository.findByemployeeFirstName(employeeFirstName).forEach(attendanceList::add);
	        return attendanceList;
	    }*/
